  ...
  return (
    <div>
      ...
      <div style={{ marginTop:'1rem', borderTop:'1px solid var(--border-mid)', paddingTop:'1rem' }}>
        ...
        <p style={{ fontSize:'.9rem' }}>Questions? See our <a href="/contact" style={{ color:'var(--accent-1)' }}>Contact page</a> or email <a href="mailto:privacy@codexclear.com" style={{ color:'var(--accent-1)' }}>privacy@codexclear.com</a>.</p>
      </div>
    </div>
  )
}
